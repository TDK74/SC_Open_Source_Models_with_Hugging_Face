...
### Acknowledgments
The Python code is from the short course "Open Source Models with Hugging Face" on the DeepLearning.AI platform. The course content is available for free, while the certificate and graded assessments require a paid subscription.  
For more details, visit:  
<https://learn.deeplearning.ai/courses/open-source-models-hugging-face/information/>
